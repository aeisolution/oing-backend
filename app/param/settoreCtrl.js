...
(function () {
	'use strict';
	var controllerId = 'settoreCtrl';
	angular.module('app').controller(controllerId, ['dataFactory', '$modal', 'toastr', settoreCtrl]);

	function settoreCtrl(dataFactory, $modal, toastr) {
		var vm = this;
		vm.title = 'Settori';
		vm.url = 'params/settore'
		vm.view = 'elenco';
		vm.elenco = [];
		vm.componente = {};
