...
(function () {
	'use strict';
	var controllerId = 'documentoCtrl';
	angular.module('app').controller(controllerId, ['dataFactory', '$modal', 'toastr', documentoCtrl]);

	function documentoCtrl(dataFactory, $modal, toastr) {
		var vm = this;
		vm.title = 'Categoria Documenti/Files';
		vm.url = 'params/documento'
		vm.view = 'elenco';
		vm.elenco = [];
		vm.componente = {};
