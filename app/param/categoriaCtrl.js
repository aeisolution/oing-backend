...
(function () {
	'use strict';
	var controllerId = 'categoriaCtrl';
	angular.module('app').controller(controllerId, ['dataFactory', '$modal', 'toastr', categoriaCtrl]);

	function categoriaCtrl(dataFactory, $modal, toastr) {
		var vm = this;
		vm.title = 'Categorie';
		vm.url = 'params/categoria'
		vm.view = 'elenco';
		vm.elenco = [];
		vm.componente = {};
