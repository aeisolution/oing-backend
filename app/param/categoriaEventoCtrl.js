...
(function () {
	'use strict';
	var controllerId = 'categoriaEventoCtrl';
	angular.module('app').controller(controllerId, ['dataFactory', '$modal', 'toastr', categoriaEventoCtrl]);

	function categoriaEventoCtrl(dataFactory, $modal, toastr) {
		var vm = this;
		vm.title = 'Categoria Eventi Consiglio';
		vm.elenco = [];
		vm.param = 'categorieEvento';		//**** impostare nome parametro (plurale prima parola)
