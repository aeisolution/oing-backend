...
(function () {
	'use strict';
	var controllerId = 'abilitazioneCtrl';
	angular.module('app').controller(controllerId, ['dataFactory', '$modal', 'toastr', abilitazioneCtrl]);

	function abilitazioneCtrl(dataFactory, $modal, toastr) {
		var vm = this;
		vm.title = 'Classi di Laurea';
		vm.elenco = [];
		vm.param = 'abilitazioni';		//**** impostare nome parametro (plurale prima parola)
